...
def evalClassifier(test_loader,model,epoch = str(289)):
...
def main(args):
    ...
    print(classification_report(y_test, y_pred, target_names=("cwl2","zool2","bdrl2","pgd","sqlinf","hsj")))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochclf",type=str,default = "289")
