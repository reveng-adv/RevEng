...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 22 18:10:19 2022
...
def loaddata(args):
    if args.dataset == 'mnist':
        ...
        data_dir = './tinyforward/tiny-imagenet-200/'
        ...
        dataloaders = {x: DataLoader(image_datasets[x], batch_size=100, shuffle=False, num_workers=num_workers[x])
                          for x in ['train', 'val', 'test']}
...
def loadmodel(args):
    if args.dataset == 'mnist':
        ...
        from tinyforward import models
        #from home.xiawei.l2_cwsqbdr_ti_f.tinyforward import models
        ...
        model.load_state_dict(torch.load('/home/xiawei/l2_cwsqbdr_ti_f/tinyforward/models/Fine/model_13_epoch.pt'))
