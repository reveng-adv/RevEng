...
def main(args):
    ...
    np.save("./features/"+args.dataset+'/x_adv2', x_test)
    np.save("./features/"+args.dataset+'/'+args.method+'_adv2', adv_samples)
    
    np.save("./features/"+args.dataset+'/'+args.method+'_labels2', labels)
    np.save("./features/"+args.dataset+'/'+args.method+'_success2', success)
    np.save('./features/'+args.dataset+'/'+args.method+'_distortion2',distortion)
    np.save('./features/'+args.dataset+'/'+args.method+'_pred_test2',predictions_test)
    np.save('./features/'+args.dataset+'/'+args.method+'_pred_adv2',predictions_adv)
