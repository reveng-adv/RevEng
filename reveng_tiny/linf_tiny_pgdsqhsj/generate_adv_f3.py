...
def main(args):
    ...
    np.save("./features/"+args.dataset+'/x_adv3', x_test)
    np.save("./features/"+args.dataset+'/'+args.method+'_adv3', adv_samples)
    
    np.save("./features/"+args.dataset+'/'+args.method+'_labels3', labels)
    np.save("./features/"+args.dataset+'/'+args.method+'_success3', success)
    np.save('./features/'+args.dataset+'/'+args.method+'_distortion3',distortion)
    np.save('./features/'+args.dataset+'/'+args.method+'_pred_test3',predictions_test)
    np.save('./features/'+args.dataset+'/'+args.method+'_pred_adv3',predictions_adv)
