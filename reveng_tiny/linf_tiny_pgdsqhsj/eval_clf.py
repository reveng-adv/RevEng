...
def evalClassifier(test_loader,model,epoch = str(49)):
...
def main(args):
    ...
    y_pred = evalClassifier(test_loader,model,epoch = str(144))
    ...
    print(classification_report(y_test, y_pred, target_names=("cwl2","sql2","bdrl2")))
