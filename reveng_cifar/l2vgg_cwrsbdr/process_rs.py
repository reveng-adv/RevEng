...
def combine(method = "CW"):
    ...
    aa = np.concatenate((a1,a2,a3,a4))
    print(aa.shape)
    np.save(path+"rs_distortion10k.npy",aa)
    ...
    aa = np.concatenate((a1,a2,a3,a4))
    print(aa.shape)
    np.save(path+"rs_pred_adv10k.npy",aa)
    ...
    aa = np.concatenate((a1,a2,a3,a4))
    print(aa.shape)
    np.save(path+"rs_pred_test10k.npy",aa)
    ...
    aa = np.concatenate((a1,a2,a3,a4))
    print(aa.shape)
    np.save(path+"rs_success10k.npy",aa)
    ...
    aa = np.concatenate((a1,a2,a3,a4))
    print(aa.shape)
    np.save(path+"rs_labels10k.npy",aa)
...
def triple_true():
    ...
    rs_p_adv = np.load(path+"CWrs_pred_adv10k.npy")
    bdr_p_adv = np.load(path+"BOUNDARY_pred_adv10k.npy")
    cw_l2 = np.load(path+"CW_distortion10k.npy")
    cw_s = (cw_l2 <=1.001)& (np.argmax(cw_p_adv, axis=1) != labels) & (np.argmax(p_test,axis=1) == labels)
    #n = np.load("./CW_success10k.npy")
    rs_l2 = np.load(path +"CWrs_distortion10k.npy")

    rs_s = (rs_l2 <=1.001) & (np.argmax(rs_p_adv, axis=1) != labels) & (np.argmax(p_test,axis=1) == labels)
    print(rs_s)
