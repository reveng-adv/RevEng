...
def evalClassifier(test_loader,model,epoch = str(4)):
...
def main(args):
    ...
    y_pred = evalClassifier(test_loader,model,epoch = str(279))
    ...
    print(classification_report(y_test, y_pred, target_names=("cwl2","cwrsl2","bdrl2")))
