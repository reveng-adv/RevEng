...
def main(args):
    ...
    print("labels",labels)
    print("success",success,"SS")
    print("distortion",distortion)
    print("predictions_test",np.shape(predictions_test),predictions_test)
    print("predictions_adv",np.shape(predictions_adv),predictions_adv)
    print(np.shape(adv_samples))
    print(adv_samples)
