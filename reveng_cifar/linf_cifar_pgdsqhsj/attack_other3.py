...
def main(args):
    ...
    if args['dataset'] == 'mnist':
        ...
        #(x_test, y_test), (_,_), min_pixel_value, max_pixel_value = load_cifar10()
        input_shape = (3,32,32)
    ...
    #x_test = x_test[:b]
    #x_test = x_test[b:2*b]
    x_test = x_test[2*b:3*b]
    y_test = y_test[2*b:3*b]
    #x_test = x_test[3k:4k]
    print(x_test.shape)
    print('==> Loading model..')
    ...
    np.save("./features/cifar10/"+args['method']+'_adv_test'+args['k'], adv_examples)
    #np.save("./features/cifar10/"+args['method']+'_adv_train'+args['k'], adv_examples)
